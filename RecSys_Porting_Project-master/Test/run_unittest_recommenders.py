...
sys.path.append('c:/Users/michelebalena/Desktop/Progetto RS/RS/RecSys_Porting_Project-master')
...
class MyTestSuite(object):
    ...
    def test_user_batch(self):
        ...
        for start_user in range(0, n_users, batch_size):
            ...
            user_id_batch = np.arange(start_user, end_user, dtype = np.int32)
...
class MyTestSuite_MatrixFactorization_SVDpp_Cython(MyTestSuite, unittest.TestCase):
...
class MyTestSuite_MultVAERecommender(MyTestSuite_stochastic, unittest.TestCase):
