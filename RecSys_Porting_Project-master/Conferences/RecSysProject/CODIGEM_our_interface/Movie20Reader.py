...
class Movie20Reader(object):
    ...
    def __init__(self, pre_splitted_path):
        ...
        super(Movie20Reader, self).__init__()
        ...
        try:
            ...
            print("Movie20Reader: Attempting to load pre-splitted data")
            ...
            print("Movie20Reader: Pre-splitted data not found, building new one")

            print("Movie20Reader: loading URM")
            ...
            #mantieni solo le valutazioni maggiori a 3
            URM_all.data = URM_all.data >= 3.0
            URM_all.eliminate_zeros()

            user_interactions = URM_all.getnnz(axis=1)  # Conta le interazioni per utente
            valid_users = user_interactions >= 10  # Mantieni solo utenti con almeno 10 interazioni

            URM_all = URM_all[valid_users, :]  # Filtra utenti con almeno 10 interazioni

            item_interactions = URM_all.getnnz(axis=0)  # Conta le interazioni per ogni item
            valid_items = item_interactions >= 10  # Mantieni solo item con almeno 10 interazioni

            URM_all = URM_all[:, valid_items]  # Filtra gli item con almeno 10 interazioni
            ...
            print("Movie20Reader: loading complete")
