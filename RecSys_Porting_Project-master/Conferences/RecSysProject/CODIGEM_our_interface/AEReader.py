...
from Data_manager.AmazonReviewData.AmazonElectronicsReader import AmazonElectronicsReader as AEReader_DataManager


class AEReader(object):
    ...
    def __init__(self, pre_splitted_path):
        ...
        try:
            ...
            print("AEReader: Attempting to load pre-splitted data (Reader)")
            ...
            print("AEReader: Pre-splitted data not found, building new one")

            print("AEReader: loading URM")
            ...
            data_reader = AEReader_DataManager()
            ...
            print("AEReader: loading complete")
